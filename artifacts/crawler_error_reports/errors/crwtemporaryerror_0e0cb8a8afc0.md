...
|---:|---|---|---:|---|---|
| 1 | `65143cd7-d782-46a5-acd0-5e5d74df13d5` | `RESOURCE` | - | False | `https://dl.google.com/android/repository/commandlinetools-mac_arm64-15859902_latest.zip` |
| 2 | `407dd186-1f0e-48e0-a269-d9fdbd444962` | `RESOURCE` | - | False | `https://edgedl.me.gvt1.com/android/studio/ide-zips/2026.1.4.7/android-studio-quail4-windows.zip` |
